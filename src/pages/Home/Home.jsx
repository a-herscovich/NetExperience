...
const Home = () => {
  return (
    <div className="home">
      <div className="twoPanels taglineSection">
        <div className="taglineAndCTA">
          ...
          <h1 className="tagline">
            NetExperience, the world’s leading management and controller
            platform for OpenWiFi
          </h1>
          <p className="supportText">
            The NetExperience platform is a cloud based management and
            controller designed for Wi-Fi focused service providers to deliver
            large scale networks in environments where enterprise-class
            sophisticated radio resource management is required but at a
            consumer budget.
          </p>
          <EmailInput />
        </div>
      ...
      <div className="openWifiSection">
        ...
        <div className="benefits">
          <OpenWifiBenefit
            icon={
              <svg
                className="benefitIcon bi bi-cash-coin"
          ...
          <OpenWifiBenefit
            icon={
              <svg
                className="benefitIcon bi bi-router"
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
          ...
          <OpenWifiBenefit
            icon={
              <svg
                className="benefitIcon bi bi-globe2"
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
      ...
      <div className="scalabilitySection">
